 ...
 * Re-derived from legacy `lib/eva/core/response-length.ts`.
 */
...
const RECOMMENDATION_PATTERNS =
  /\b(recommend|suggestion|suggest|what (should i|can i)|which|options?|ideas?|plan|detail|detailed|explain|tell me more|how do i|compare)\b/i;
const YES_NO_PATTERNS = /\b(yes|no|yeah|nope|sure|ok|okay|maybe)\s*[.?!]*$/i;

export function getResponseLengthInstruction(userMessage: string): string {
