import type { AssistantDefinition } from "./catalog";

/**
 * Structured overlay appended after domain base prompt — persona-specific
 * lens without replacing Studio safety rules.
 */
