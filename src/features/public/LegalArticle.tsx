...
export const LEGAL_PAGES = {
  ...
  privacy: {
    ...
    body: [
      ...
      "Contact hello@furnish-es.com to access, correct, or delete personal data, or to ask about this notice.",
    ],
  },
  refunds: {
    path: routes.refunds,
    ...
    body: [
      ...
      "For a paid order, email hello@furnish-es.com with the order number. We will match the provider’s refund event to the order once it arrives.",
